...
pub fn restriction_map(source: &Section, target: &Section) -> String {
    [
        ...
        format!(
            "  &lt;link property=\"sheaf:source\" href=\"#{}\" /&gt;",
            source.cid
        ),
        format!(
            "  &lt;link property=\"sheaf:target\" href=\"#{}\" /&gt;",
            target.cid
        ),
        format!(
            "  &lt;meta property=\"sheaf:coboundary\" content=\"δ: H/{} → H/{}\" /&gt;",
            source.encoding.name(),
            target.encoding.name()
        ),
        format!(
            "  &lt;meta property=\"sheaf:primeRatio\" content=\"{}/{}\" /&gt;",
            source.encoding.prime(),
            target.encoding.prime()
        ),
        format!(
            "  &lt;meta property=\"dasl:eigenflow\" content=\"{} → {}\" /&gt;",
            source.eigenspace.name(),
            target.eigenspace.name()
        ),
        "&lt;/div&gt;".to_string(),
    ]
    .join("\n")
